...
* [cheatsheet](cheatsheet/good.md)
  ...
  * [text-processing](cheatsheet/text-processing/text-processing.md)
    ...
    * [markdown](cheatsheet/text-processing/markdown.md)
...
* [virtualization](virtualization/virtualization.md)
  * [kubernetes](virtualization/kubernetes/kubernetes.md)
    * [init](virtualization/kubernetes/init/init.md)
      * [by kubespray](virtualization/kubernetes/init/kubespray.md)
      * [by kubeadm](virtualization/kubernetes/init/kubeadm/kubeadm.md)
        * [environment setup](virtualization/kubernetes/init/kubeadm/env.md)
        * [crio for k8s v1.30.4](virtualization/kubernetes/init/kubeadm/crio.1.30.4.md)
        * [docker for k8s v1.15.3](virtualization/kubernetes/init/kubeadm/ha-init.1.15.3.md)
