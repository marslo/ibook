...
- [certificate working with os](#certificate-working-with-os)
  - [MacOS](#macos)
...
<!--sec data-title="check more details" data-id="section7" data-show=true data-collapse=true ces-->
```bash
...
<!--sec data-title="check more details" data-id="section8" data-show=true data-collapse=true ces-->
```bash
$ ls -Altrh
total 80K
...
<!--sec data-title="check more details" data-id="section9" data-show=true data-collapse=true ces-->
```bash
...
<!--sec data-title="ssl with ip" data-id="section10" data-show=true data-collapse=true ces-->
```bash
$ sudo openssl genrsa -des3 -out artifactorykey 2048
Generating RSA private key, 2048 bit long modulus
.........................+++
...
<!--sec data-title="ssl with domain" data-id="section11" data-show=true data-collapse=true ces-->
```bash
$ sudo openssl genrsa -des3 -out artifactorykey 2048
Generating RSA private key, 2048 bit long modulus
........................+++
