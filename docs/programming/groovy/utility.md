...
>
> **minus**:
> - `minusYears()`   – Returns the copy of this LocalDateTime with the specified years subtracted.
> - `minusMonths()`  – Returns the copy of this LocalDateTime with the specified months subtracted.
> - `minusDays()`    – Returns the copy of this LocalDateTime with the specified days subtracted.
> - `minusHours()`   – Returns the copy of this LocalDateTime with the specified hours subtracted.
> - `minusMinutes()` – Returns the copy of this LocalDateTime with the specified minutes subtracted.
> - `minusSeconds()` – Returns the copy of this LocalDateTime with the specified seconds subtracted.
> - `minusNanos()`   – Returns the copy of this LocalDateTime with the specified nanoseconds subtracted.
{% endhint %}
