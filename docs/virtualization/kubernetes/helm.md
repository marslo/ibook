...
## [install](https://v2.helm.sh/docs/using_helm/#installing-helm)

> [!NOTE|label:references:]
> - [安装Helm](https://www.coderdocument.com/docs/helm/v2/using_helm/installing_helm.html#anzhuangtiller)
...
<!--sec data-title="helm version" data-id="section0" data-show=true data-collapse=true ces-->
```bash
$ helm version
...
<!--sec data-title="helm help" data-id="section1" data-show=true data-collapse=true ces-->
```bash
$ helm --help
...
### [add repo](https://github.com/jenkinsci/helm-charts)
```bash
...
<!--sec data-title="stdout" data-id="section2" data-show=true data-collapse=true ces-->
```bash
STDOUT:
...
controller:
  ...
  # This values should not be changed unless you use your custom image of jenkins or any derived from. If you want to use
  ...
  sidecars:
    ...
    ##
    ## Note: To use it you should go to https://smee.io/new and update the url to the generate one.
    # - name: smee
